                    ...
                    <div class="header-right">
                        <ul class="top-menu">
                            <li>
                                <a href="#">Links</a>
                                <ul>
                                    <li><a href="tel:#"><i class="icon-phone"></i>Call: +92 03419689719</a></li>
                                    <li><a href="{{ route('whishlist') }}"><i class="icon-heart-o"></i>My Wishlist
                                            <span>(3)</span></a></li>
                                    <li><a href="{{ route('about') }}">About Us</a></li>
                                    <li><a href="{{ route('contact') }}">Contact Us</a></li>
                                    <li><a href="{{ route('login') }}" data-toggle="modal"><i class="icon-user"></i>Login</a>
                                    </li>
                                </ul>
                            </li>
                        </ul><!-- End .top-menu -->
                ...
                <div class="container">
                                        ...
                                        <div class="menu-col">
                                            ...
                                            <div class="demo-list">
                                                ...
                                                <div class="demo-item">
                                                    <a href="index-4.html">
                                                        <span class="demo-bg"
                                                            style="background-image: url({{ asset('assets/images/menu/demos/4.jpg') }});"></span>
                                                ...
                                                <div class="demo-item">
                                                    <a href="index-5.html">
                                                        <span class="demo-bg"
                                                            style="background-image: url({{ asset('assets/images/menu/demos/5.jpg') }});"></span>
                                                ...
                                                <div class="demo-item">
                                                    <a href="index-6.html">
                                                        <span class="demo-bg"
                                                            style="background-image: url({{ asset('assets/images/menu/demos/6.jpg') }});"></span>
                                                ...
                                                <div class="demo-item">
                                                    <a href="index-7.html">
                                                        <span class="demo-bg"
                                                            style="background-image: url({{ asset('assets/images/menu/demos/7.jpg') }});"></span>
                                                ...
                                                <div class="demo-item">
                                                    <a href="index-8.html">
                                                        <span class="demo-bg"
                                                            style="background-image: url({{ asset('assets/images/menu/demos/8.jpg') }});"></span>
                                                ...
                                                <div class="demo-item">
                                                    <a href="index-9.html">
                                                        <span class="demo-bg"
                                                            style="background-image: url({{ asset('assets/images/menu/demos/9.jpg') }});"></span>
                                                ...
                                                <div class="demo-item">
                                                    <a href="index-10.html">
                                                        <span class="demo-bg"
                                                            style="background-image: url({{ asset('assets/images/menu/demos/10.jpg') }});"></span>
                                                ...
                                                <div class="demo-item hidden">
                                                    <a href="index-11.html">
                                                        <span class="demo-bg"
                                                            style="background-image: url({{ asset('assets/images/menu/demos/11.jpg') }});"></span>
                                                ...
                                                <div class="demo-item hidden">
                                                    <a href="index-12.html">
                                                        <span class="demo-bg"
                                                            style="background-image: url({{ asset('assets/images/menu/demos/12.jpg') }});"></span>
                                                ...
                                                <div class="demo-item hidden">
                                                    <a href="index-13.html">
                                                        <span class="demo-bg"
                                                            style="background-image: url({{ asset('assets/images/menu/demos/13.jpg') }});"></span>
                                                ...
                                                <div class="demo-item hidden">
                                                    <a href="index-14.html">
                                                        <span class="demo-bg"
                                                            style="background-image: url({{ asset('assets/images/menu/demos/14.jpg') }});"></span>
                                                ...
                                                <div class="demo-item hidden">
                                                    <a href="index-15.html">
                                                        <span class="demo-bg"
                                                            style="background-image: url({{ asset('assets/images/menu/demos/15.jpg') }});"></span>
                                                ...
                                                <div class="demo-item hidden">
                                                    <a href="index-16.html">
                                                        <span class="demo-bg"
                                                            style="background-image: url({{ asset('assets/images/menu/demos/16.jpg') }});"></span>
                                                ...
                                                <div class="demo-item hidden">
                                                    <a href="index-17.html">
                                                        <span class="demo-bg"
                                                            style="background-image: url({{ asset('assets/images/menu/demos/17.jpg') }});"></span>
                                                ...
                                                <div class="demo-item hidden">
                                                    <a href="index-18.html">
                                                        <span class="demo-bg"
                                                            style="background-image: url({{ asset('assets/images/menu/demos/18.jpg') }});"></span>
                                                ...
                                                <div class="demo-item hidden">
                                                    <a href="index-19.html">
                                                        <span class="demo-bg"
                                                            style="background-image: url({{ asset('assets/images/menu/demos/19.jpg') }});"></span>
                                                ...
                                                <div class="demo-item hidden">
                                                    <a href="index-20.html">
                                                        <span class="demo-bg"
                                                            style="background-image: url({{ asset('assets/images/menu/demos/20.jpg') }});"></span>
                                                ...
                                                <div class="demo-item hidden">
                                                    <a href="index-21.html">
                                                        <span class="demo-bg"
                                                            style="background-image: url({{ asset('assets/images/menu/demos/21.jpg') }});"></span>
                                                ...
                                                <div class="demo-item hidden">
                                                    <a href="index-22.html">
                                                        <span class="demo-bg"
                                                            style="background-image: url({{ asset('assets/images/menu/demos/22.jpg') }});"></span>
                                                ...
                                                <div class="demo-item hidden">
                                                    <a href="index-23.html">
                                                        <span class="demo-bg"
                                                            style="background-image: url({{ asset('assets/images/menu/demos/23.jpg') }});"></span>
                                                ...
                                                <div class="demo-item hidden">
                                                    <a href="index-24.html">
                                                        <span class="demo-bg"
                                                            style="background-image: url({{ asset('assets/images/menu/demos/24.jpg') }});"></span>
                    ...
                    <div class="header-right">
                        ...
                        <div class="dropdown cart-dropdown">
                            <a href="{{ route('cart') }}" class="dropdown-toggle" role="button" data-toggle="dropdown"
                                    ...
                                    <div class="intro-slide">
                                        <figure class="slide-image">
                                            <picture>
                                                ...
                                                <img src="{{ asset('assets/images/slider/slide-1.jpg') }}"
                                                    alt="Image Desc">
                                            </picture>
                                    ...
                                    <div class="intro-slide">
                                        <figure class="slide-image">
                                            <picture>
                                                ...
                                                <img src="{{ asset('assets/images/slider/slide-2.jpg') }}"
                                                    alt="Image Desc">
                                            </picture>
                                        </figure><!-- End .slide-image -->
                                        ...
                                        <div class="banner banner-display">
                                            ...
                                            <div class="banner-content">
                                                <h4 class="banner-subtitle text-darkwhite"><a
                                                        href="#">Clearence</a></h4><!-- End .banner-subtitle -->
...
@foreach ( $products as $product )
                            <div class="product product-11 text-center">
                                ...
                                <div class="product-action">
                                    <a href="{{ route('product.view', $product->id) }}" class="btn-product btn-cart"><span>add to cart</span></a>
                    ...
                    <div class="col-sm-12 col-lg-4 banners-sm">
                        <div class="row">
                            <div class="banner banner-display banner-link-anim col-lg-12 col-6">
                                <a href="#">
                                    <img src="{{ asset('assets/images/banners/home/banner-2.jpg') }}" alt="Banner">
                                </a>
                            ...
                            <div class="banner banner-display banner-link-anim col-lg-12 col-6">
                                <a href="#">
                                    <img src="{{ asset('assets/images/banners/home/banner-3.jpg') }}" alt="Banner">
                                </a>
                    ...
                    <ul class="nav nav-pills nav-border-anim justify-content-center" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="top-decor-link" data-toggle="tab" href="#top-decor-tab"
                                role="tab" aria-controls="top-decor-tab" aria-selected="false">Decor</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="owl-carousel owl-simple carousel-with-shadow" data-toggle="owl"
                        ...
                        <article class="entry entry-display">
                            <figure class="entry-media">
                                <a href="single.html">
                                    <img src="{{ asset('assets/images/blog/home/post-1.jpg') }}" alt="image desc">
                                </a>
                        ...
                        <article class="entry entry-display">
                            <figure class="entry-media">
                                <a href="single.html">
                                    <img src="{{ asset('assets/images/blog/home/post-2.jpg') }}" alt="image desc">
                                </a>
                            </figure><!-- End .entry-media -->
                        ...
                        <article class="entry entry-display">
                            <figure class="entry-media">
                                <a href="single.html">
                                    <img src="{{ asset('assets/images/blog/home/post-3.jpg') }}" alt="image desc">
                                </a>
                            </figure><!-- End .entry-media -->

@include('user.Header')
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="member member-anim text-center">
                                <figure class="member-media">
                                    <img src="{{ asset('assets/images/team/member-1.jpg') }}" alt="member photo">
                        ...
                        <div class="col-md-4">
                            <div class="member member-anim text-center">
                                <figure class="member-media">
                                    <img src="{{ asset('assets/images/team/member-2.jpg') }}" alt="member photo">
                        ...
                        <div class="col-md-4">
                            <div class="member member-anim text-center">
                                <figure class="member-media">
                                    <img src="{{ asset('assets/images/team/member-3.jpg') }}" alt="member photo">
                    ...
                    <div class="container">
                        ...
                        <div class="owl-carousel owl-simple owl-testimonials-photo" data-toggle="owl"
                            ...
                            <blockquote class="testimonial text-center">
                                <img src="{{ asset('assets/images/testimonials/user-1.jpg') }}" alt="user">

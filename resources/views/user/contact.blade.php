                        ...
                        <ul class="top-menu">
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li><a href="{{ route('whishlist') }}"><i class="icon-heart-o"></i>Wishlist <span>(3)</span></a></li>
                                            ...
                                            <div class="demo-list">
                                                ...
                                                <div class="demo-item hidden">
                                                    <a href="index-24.html">
                                                        <span class="demo-bg" style="background-image: url({{ asset('assets/images/menu/demos/24.jpg') }});"></span>
	                				...
	                				<div class="row">
	                					...
	                					<div class="col-sm-7 col-xl-6">
	                						<div class="store-content">
	                							<h3 class="store-title">Kashif Store</h3><!-- End .store-title -->
	                							<address>G13/1 ISLAMABAD PAKISTAN</address>
	                							<div><a href="tel:#">03419689719</a></div>
	                				...
	                				<div class="row">
	                					...
	                					<div class="col-sm-7 col-xl-6">
	                						<div class="store-content">
	                							...
	                							<address>F10/2 ISLAMABAD PAKISTAN</address>
	                							<div><a href="tel:#">03419689719</a></div>
